<div class="container">
    <div class="row">
        <div class="col">
            <h1 class="font-weight-bold">Kemaskini Pengguna</h1>
            <hr>
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <label>Nama</label>
                    <input class="form-control <?php echo isset($errors_bag['nama']) ? 'is-invalid' : null; ?>" type="text" name="nama" value="<?php echo $_POST['nama'] ?? $pengguna->nama; ?>" autofocus>
                ...
                <div class="form-group">
                    <label>Emel</label>
                    <input class="form-control <?php echo isset($errors_bag['emel']) ? 'is-invalid' : null; ?>" type="email" name="emel" value="<?php echo $_POST['emel'] ?? $pengguna->emel; ?>">
